...
switch(game_data.locale) {
  case "pt_BR":
    langScript = [
        ...
        "DEF na aldeia",
        "Fazendas: ",
        "versão para mundos sem arqueiros"
    ]
    break;
  default:
    langScript = [
        ...
        "DEF in the village",
        "Farms: ",
        "Version for worlds without archers"
    ]
}      
...
$("#hofcio_suma_off")[0].innerHTML = "<font color=red>" + langScript[8] + "</font><br>" + langScript[11] + "<b>"+hofcio_sum[2]+"</b><br>" + langScript[12] + "<b>"+hofcio_sum[4]+"</b><br>" + langScript[14] + "<b>"+hofcio_sum[6]+"</b>";
$("#hofcio_suma_def")[0].innerHTML = "<font color=red>" + langScript[9] + "</font><br>" + langScript[15] + "<b>"+hofcio_sum[0]+"</b><br>" + langScript[16] + "<b>"+hofcio_sum[1]+"</b><br>" + langScript[18] + "<b>"+hofcio_sum[5]+"</b><br><br>" + langScript[19] + "<b>"+zagrody+"</b>";
$("#hofcio_suma_o")[0].innerHTML = "<font color=red>" + langScript[10] + "</font><br>" + langScript[20] + "<b>"+hofcio_sum[3]+"</b><br>" + langScript[21] + "<b>"+hofcio_sum[7]+"</b><br>" + langScript[22] + "<b>"+hofcio_sum[8]+"</b><br>" + langScript[23] + "<b>"+hofcio_sum[9]+"</b>";
$("#hofcio_suma_in")[0].innerHTML = "<h4>" + langScript[24] + "</h4>" + langScript[15] + "<b>"+tablicax[1]+"</b><br>" + langScript[16] + "<b>"+tablicax[2]+"</b><br>" + langScript[18] + "<b>"+tablicax[6]+"</b><br>" + langScript[25] + "<b>"+razemzag+"</b><br>" + langScript[21] + "<b>"+tablicax[8]+"</b><br>" + langScript[22] + "<b>"+tablicax[9]+"</b><br>";
}}else{
    switch(game_data.locale) {
        case "pt_BR":
