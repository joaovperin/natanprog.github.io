/* 
	...
	TODO	:
		...
		* Add filtering by village name/continent on all overview screens
...
function fnRefreshVillageCount(){
	var villageCount=$('table.overview_table tr td a:[href*="screen='+(($('#buildings_table').length>0)?'main':'overview')+'"]').length;
	var $hdr=$('table.overview_table tr:eq(0) th:eq('+(($('#buildings_table').length>0)?2:(fnHasNotebook()?1:0))+')');
...
function fnCreateIncomingsFilterCriteriaPopup(){
	var popupHeight = 465;
	if(fnHasArchers()){
		popupHeight += 25*2;
	}
	...
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_a\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><span>Command</span></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td colspan=\"2\"><input type=\"text\" name=\"dsmCommand\" id=\"dsmCommand\" size=\"12\" maxlength=\"32\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";	

	// Create a Separator.
	docSource += "\t\t\t\t\t\t\t\t<tr><td colspan=\"3\"><hr></td></tr>\n";

	// Create Destination Village Content.
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_a\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><span>Destination Village Name</span></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td colspan=\"2\"><input type=\"text\" name=\"dest_village_name\" id=\"dest_village_name\" size=\"12\" maxlength=\"32\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><span>Destination Continent</span></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"min_dest_continent\" id=\"min_dest_continent\" size=\"5\" maxlength=\"2\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"max_dest_continent\" id=\"max_dest_continent\" size=\"5\" maxlength=\"2\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";

/*
	if(has source village){
		// Create a Separator.
		docSource += "\t\t\t\t\t\t\t\t<tr><td colspan=\"3\"><hr></td></tr>\n";

		// Create Source Village Content.
		docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_a\" style=\"white-space:nowrap;\">\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><span>Source Village Name</span></td>\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td colspan=\"2\"><input type=\"text\" name=\"src_village_name\" id=\"src_village_name\" size=\"12\" maxlength=\"32\"/></td>\n";
		docSource += "\t\t\t\t\t\t\t\t</tr>\n";
		docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><span>Source Continent</span></td>\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"min_src_continent\" id=\"min_src_continent\" size=\"5\" maxlength=\"2\"/></td>\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"max_src_continent\" id=\"max_src_continent\" size=\"5\" maxlength=\"2\"/></td>\n";
		docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	}
*/
	...
	// Create Attacking Player Content.
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_a\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><span>Player</span></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td colspan=\"2\"><input type=\"text\" name=\"dsmPlayer\" id=\"dsmPlayer\" size=\"12\" maxlength=\"32\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";	

	// Create a Separator.
	docSource += "\t\t\t\t\t\t\t\t<tr><td colspan=\"3\"><hr></td></tr>\n";

	// Create Arrival Time Content.
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><span>Arrival Time</span></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"min_arrival_time\" id=\"min_arrival_time\" size=\"5\" maxlength=\"2\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"max_arrival_time\" id=\"max_arrival_time\" size=\"5\" maxlength=\"2\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";

	// Create Arrival In Content.
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><span>Arrival In</span></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"min_arrival_in\" id=\"min_arrival_in\" size=\"5\" maxlength=\"2\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"max_arrival_in\" id=\"max_arrival_in\" size=\"5\" maxlength=\"2\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";

	docSource += "\t\t\t\t\t\t\t</table>\n";
	docSource += "\t\t\t\t\t\t\t<br/>\n";
	docSource += "\t\t\t\t\t\t\t<hr>\n";
	docSource += "\t\t\t\t\t\t\t<div align=\"right\"><input type=\"button\" name=\"filter\" value=\"Apply Filter\" style=\"font-size:10pt;\" onClick=\"self.opener.fnFilterIncomings();self.close();\"></div>\n";
	docSource += "\t\t\t\t\t\t\t<br/>\n";
...
function fnCreateBuildingsFilterCriteriaPopup(){
	...
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_a\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/main.png?1\" alt=\"\"/><span>"+buildingDesc.main+"</span></td>\n";
	...
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/barracks.png?1\" alt=\"\"/><span>"+buildingDesc.barracks+"</span></td>\n";
	...
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/stable.png?1\" alt=\"\"/><span>"+buildingDesc.stable+"</span></td>\n";
	...
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/garage.png?1\" alt=\"\"/><span>"+buildingDesc.garage+"</span></td>\n";
	...
	if(fnHasChurch()){
		docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/church.png?1\" alt=\"\"/><span>"+buildingDesc.church+"</span></td>\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"min_church\" id=\"min_church\" size=\"5\" maxlength=\"5\"/></td>\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"max_church\" id=\"max_church\" size=\"5\" maxlength=\"5\"/></td>\n";
		docSource += "\t\t\t\t\t\t\t\t</tr>\n";
		docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/church.png?1\" alt=\"\"/><span>"+buildingDesc.church_f+"</span></td>\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"min_church_f\" id=\"min_church_f\" size=\"5\" maxlength=\"5\"/></td>\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"max_chruch_f\" id=\"max_church_f\" size=\"5\" maxlength=\"5\"/></td>\n";
		docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	}
	
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/snob.png?1\" alt=\"\"/><span>"+buildingDesc.snob+"</span></td>\n";
	...
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/smith.png?1\" alt=\"\"/><span>"+buildingDesc.smith+"</span></td>\n";
	...
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/place.png?1\" alt=\"\"/><span>"+buildingDesc.place+"</span></td>\n";
	...
	if(fnHasPaladin()){
		docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/statue.png?1\" alt=\"\"/><span>"+buildingDesc.statue+"</span></td>\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"min_statue\" id=\"min_statue\" size=\"5\" maxlength=\"5\"/></td>\n";
		docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"max_statue\" id=\"max_statue\" size=\"5\" maxlength=\"5\"/></td>\n";
		docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	}
	
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/market.png?1\" alt=\"\"/><span>"+buildingDesc.market+"</span></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"min_market\" id=\"min_market\" size=\"5\" maxlength=\"5\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"max_market\" id=\"max_market\" size=\"5\" maxlength=\"5\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/wood.png?1\" alt=\"\"/><span>"+buildingDesc.wood+"</span></td>\n";
	...
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/stone.png?1\" alt=\"\"/><span>"+buildingDesc.stone+"</span></td>\n";
	...
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/iron.png?1\" alt=\"\"/><span>"+buildingDesc.iron+"</span></td>\n";
	...
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/farm.png?1\" alt=\"\"/><span>"+buildingDesc.farm+"</span></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"min_farm\" id=\"min_farm\" size=\"5\" maxlength=\"5\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"max_farm\" id=\"max_farm\" size=\"5\" maxlength=\"5\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/storage.png?1\" alt=\"\"/><span>"+buildingDesc.storage+"</span></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"min_warehouse\" id=\"min_warehouse\" size=\"5\" maxlength=\"5\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"max_warehouse\" id=\"max_warehouse\" size=\"5\" maxlength=\"5\"/></td>\n";
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/hide.png?1\" alt=\"\"/><span>"+buildingDesc.hide+"</span></td>\n";
	...
	docSource += "\t\t\t\t\t\t\t\t</tr>\n";
	docSource += "\t\t\t\t\t\t\t\t<tr class=\"row_b\" style=\"white-space:nowrap;\">\n";
	docSource += "\t\t\t\t\t\t\t\t\t<td><img src=\"http://" + window.location.hostname + "/graphic/buildings/wall.png?1\" alt=\"\"/><span>"+buildingDesc.wall+"</span></td>\n";
...
function fnFilterCommands(){
	try{
		setTimeout("alert('Coming soon (ish)...\nmost probably');",200);
...
function fnFilterBuildings(){
	try{
		...
		// (Number of Columns) - HammerColumn - DestroyColumn - VillageColumn - AssignmentColumn.
		var colCount = $('#buildings_table thead th').length - 4;

		$('#buildings_table tr.vrow').each(function(row,eleRow){
			$(eleRow).find('td:gt(2):lt('+colCount+')').each(function(cell,eleCell){
				// Filter by Points/Buildings Criteria.
				var strData=$(eleCell).text();
				var qty=parseInt(strData,10);
				var criteria=criteriaArray[cell];
				if(((criteria.min >= 0) && (qty < criteria.min)) || ((criteria.max >= 0) && (qty > criteria.max))){
					eleRow.parentNode.removeChild(eleRow);
					return false;
				}
			});
...
try{
	...
	if(!win.game_data.mode){
		var vmode=($('#overview_menu td.selected a').attr('href')||'').match(/mode\=(\w*)/i);
		if(vmode){
	...
	switch((win.game_data.mode||'').toLowerCase()){
		case 'combined':popupFilterCriteria=fnCreateCombinedFilterCriteriaPopup();break;	
		case 'prod':popupFilterCriteria=fnCreateProductionFilterCriteriaPopup();break;			
		//case 'trader':break; // TODO
		case 'units':popupFilterCriteria=fnCreateTroopsFilterCriteriaPopup();break;			
		//case 'commands':break; // TODO
		//case 'incomings':break; // TODO //popupFilterCriteria=fnCreateIncomingsFilterCriteriaPopup();break;
		case 'buildings':popupFilterCriteria=fnCreateBuildingsFilterCriteriaPopup();break;			
		//case 'tech':break;	// TODO
		//case 'groups':break; // TODO
		default:
			throw([
				'This script must be run from:',
				'Overviews->Combined Screen',
				'Overviews->Production Screen',
				//'Overviews->Trades Screen', // TODO
				'Overviews->Troops Screen',
				//'Overviews->Commands Screen', // TODO
				//'Overviews->Incomings Screen', // TODO
				'Overviews->Buildings Screen'
				//'Overviews->Research Screen', // TODO
				//'Overviews->Groups Screen' // TODO
			].join('\n\t* '));
	}
