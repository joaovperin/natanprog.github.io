 ...
 *	Name: FA Filter
 *	Version: 3
 *	Client script: javascript:$.getScript('https://dl.dropboxusercontent.com/u/26362756/faFilter/faFilter.js');void(0);
 */
...
function addLanguages(){
	...
	//$('#language').append("<option value='pt'>PortuguÃªs</option>");
	//$('#language').append("<option value='cs'>ÄŒeÅ¡tina</option>");
	//$('#language').append("<option value='ko'>í•œêµ­ì–´</option>");
	//$('#language').append("<option value='ro'>Ð ÑƒÑÑÐºÐ¸Ð¹</option>");
	//$('#language').append("<option value='el'>Î•Î»Î»Î·Î½Î¹ÎºÎ¬</option>");
	//$('#language').append("<option value='no'>Norsk</option>");
	//$('#language').append("<option value='sk'>SlovenÄina</option>");
	...
	//$('#language').append("<option value='tr'>TÃ¼rkÃ§e</option>");
	$('#language').append("<option value='fr'>Français</option>");
	$('#language').append("<option value='es'>EspaÃ±ol</option>");
	//$('#language').append("<option value='fi'>finnish</option>");
	//$('#language').append("<option value='ar'>Ø§Ù„Ù„ØºØ© Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©</option>");
	//$('#language').append("<option value='sl'>SlovenÅ¡Äina</option>");
	//$('#language').append("<option value='lt'>LietuviÅ³</option>");
