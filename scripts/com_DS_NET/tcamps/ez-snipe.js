    ...
    */

    {
        ...
        translations.br = (() => {
            ...
            br[INTL.T_RUN_ON_INCOMINGS] = 'Este script precisa ser executado na página Chegando, vou trazer à você agora';
            ...
            br[INTL.T_INCOMING_SUPPORT_BUFF] = 'Apoio recebido enquanto isso estiver ativo vai viajar {{perc}}% mais rápido';
            ...
            br[INTL.T_REFRESH_1] = 'Este script não será atualizado quando você marcar/desmascar as entradas abaixo.';
            br[INTL.T_REFRESH_2] = 'Rode o script novamente para atualizar com aquelas mudanças.';
