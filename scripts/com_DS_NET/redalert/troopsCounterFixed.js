...
function fnCalculateTroopCount() {
    ...
    docSource += '</table>';
    docSource += `<small><strong>Troops Counter ${strVersion}</strong> - <a href="https://twscripts.ga/" rel="noopener noreferrer" target="_blank">RedAlert</a> - <a href="https://forum.tribalwars.net/index.php?threads/troops-counter-by-dalesmckay-fixed.285246/" rel="noopener noreferrer" target="_blank">Help</a>`;
    docSource += '</body>';
    docSource += '</html>';
