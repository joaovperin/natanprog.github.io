    ...
    if (!TwCheese.hasTool(toolId)) {
                    ...
                    <div id="twcheese_pillaging_stats" class="vis widget">
                        <h4>
                            ...
                            <span style="font-size: 10px; font-style: normal; font-weight: normal; margin-right: 25px; float: right;">
                                készítette: <a target="_blank" href="https://forum.tribalwars.net/index.php?members/28484/">cheesasaurus</a>
                            </span>
                        </h4>
                        <div id="twcheese_pillaging_stats_content" style="display: ${contentDisplay};">
                            ...
                            <div class="twcheese-pillaging-stats-summation">
                                <div style="text-align: center; width: 100%; margin-top: 5px; margin-bottom: 5px;">
                                     <select id="twcheese_pillaging_stats_from">${summationFromOptions.join('')}</select>-tól
                                     <select id="twcheese_pillaging_stats_to">${summationToOptions.join('')}</select>-ig
                                </div>
                            ...
                            <table class="twcheese-pillaging-stats-hourly-breakdown" width="100%">
                                <tbody>
                                    <tr><td colspan="6" style="text-align: center; font-size: 16px;">Beérkező nyersanyagok ${pageInfo}</td></tr>
                                    <tr>
                                        <th>Érkezés</th>
        ...
        function promptLoadHauls(onConfirm) {
            ...
            $('#twcheese_hauls_prompt_confirm').on('click', async function(e) {
                e.preventDefault();
                document.getElementById('twcheese_servant_text').innerHTML = '<br/>A sajt legyen veled.';
                ...
                <div style="height: 100%; width: 100%; background: url('${ImageSrc["a" /* ImageSrc */].popupBackground}')">
                    <div style="background: no-repeat url('${ImageSrc["a" /* ImageSrc */].servant}');">
                        <div id="twcheese_servant_text">
                            <p style="font-size: 16px;">Üdvözöllek,</p>
                            <p>Szeretnéd a fosztogatásokat megjeleníteni?</p>
                        </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td id="twcheese_servant_info_prompt" class="twcheese-servant-info">
                                            <h5>Farmolási információk betöltése?</h5>
                                            <p>Ez eltarthat egy ideig, ha sok parancs van.</p>
                                            <div class="confirmation-buttons">
                                                <button id="twcheese_hauls_prompt_confirm" class="btn btn-confirm-yes">Igen</button>
                                                <button id="twcheese_hauls_prompt_cancel" class="btn btn-default">Nem</button>
                                            </div>
                                        </td>
                                        <td id="twcheese_servant_info_loading" class="twcheese-servant-info" style="display: none;">
                                            <h5>Fosztogatások betöltése</h5>
        ...
        function buildContent(message, options) {
            ...
            if (options.skippableId) {
                html += `<div class="twcheese-suggest-redirect-skip-container">
                    ...
                    <span>Legközelebb ne kérdezd, hanem egyből vigyél oda.</span>
                </div>`
            }
            return html;
        }
        ...
        async function alertPremiumRequired() {
            let message = `
                Ez a script olyan funkciókra támaszkodik, amelyek csak a <a href="game.php?screen=premium">prémium</a> felhasználók számára érhetőek el.
                <br/>
                <p style="font-size: 10px;">
                    $999-ért monitorállványt vásárolhatnál
                    <br/>Vagy <strong>30+ év</strong> kh prémium fiókot!
                </p>`;
        
            let buttonText = `Úgy nézek ki, mint aki pénzt keres?`;
        ...
        function suggestRedirectToCommandsOverview() {
            suggestRedirect({
                message: `
                    <p style="font-size:14px;">A használatához a Parancsok felületen kell lenned.</p>
                    <p style="font-size:12px;">Válaszd a visszatérő fület, hisz csak azok a csapatok hozhatnak magukkal nyersanyagot. :)</p>`,
