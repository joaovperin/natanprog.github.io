                                ...
                                <td colspan="10" id="massScavengeSophieTitle" style="text-align:center; width:auto; background-color:${headerColor}">
                                    <h2>
                                        <center style="margin:10px"><u>
                                                <font color="${titleColor}">Gyűjtögetés: csoportonként 50 faluból</font>
                                            </u>
                                        </center>
                                    </h2>
                                </td>
    ...
    <div id="massScavengeSophie" class="ui-widget-content" style="position:fixed;background-color:${backgroundColor};cursor:move;z-index:50;">
        <table id="massScavengeSophieTable" class="vis" border="1" style="width: 100%;background-color:${backgroundColor};border-color:${borderColor}">
            <tr>
                <td colspan="10" id="massScavengeSophieTitle" style="text-align:center; width:auto; background-color:${headerColor}">
                    <h2>
                        <center style="margin:10px"><u>
                                <font color="${titleColor}">Tömeges gyűjtögetés</font>
                            </u>
                        </center>
                    </h2>
                </td>
            ...
            <tr style="background-color:${backgroundColor}">
                <td style="text-align:center;background-color:${headerColor}" colspan="15">
                    <h2>
                        <center style="margin:10px"><u>
                                <font color="${titleColor}">Válassz egységeket a gyűjtögetéshez</font>
                            </u></center>
                    </h2>
                </td>
            </tr>
            ...
            <tbody>
                <tr style="background-color:${backgroundColor}">
                    <td style="text-align:center;background-color:${headerColor}" colspan="4">
                        <h2>
                            <center style="margin:10px"><u>
                                    <font color="${titleColor}">Válassz gyűjtögetési kategóriákat</font>
                            </u></center>
                        </h2>
                    </td>
                </tr>
        ...
        <hr>
        <center>
            <font color="${titleColor}">Hány órára legyenek kiküldve az egységek? </font>
        </center>
        <br>
        <center><textarea id="runTime" cols="12" style="background-color:${backgroundColor};color:${titleColor};resize:none;" placeholder="Írd ide"></textarea></center>
        <hr>
        <center><input type="button" class="btn evt-confirm-btn btn-confirm-yes" id="sendMass" onclick="readyToSend()" value="Kiküldő gyorsgombok generálása"></center>
        <hr>
