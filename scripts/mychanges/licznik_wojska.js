...
licznik_wojska.nazwyJednostek = langScript[game_data.locale]["0"]+","+langScript[1]+","+langScript[2]+","+langScript[3]+","+langScript[4]+","+langScript[5]+","+langScript[6]+","+langScript[7]+","+langScript[8]+","+langScript[9]+","+langScript[10]+","+langScript[11].split(",");
