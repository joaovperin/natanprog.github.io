...
$("#hofcio_suma_o")[0].innerHTML = "<font color=red>" + langScript[10] + "</font><br>" + langScript[19] + "<b>"+hofcio_sum[4]+"</b><br>" + langScript[20] + "<b>"+hofcio_sum[9]+"</b><br>" + langScript[21] + "<b>"+hofcio_sum[10]+"</b><br>" + langScript[22] + "<b>"+hofcio_sum[11]+"</b>";
