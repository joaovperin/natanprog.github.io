...
$("#hofcio_suma_in")[0].innerHTML = "<h4>" + langScript[24] + "</h4>" + langScript[15] + "<b>"+tablicax[1]+"</b><br>" + langScript[16] + "<b>"+tablicax[2]+"</b><br>" + langScript[17] + "<b>"+tablicax[4]+"</b><br>" + langScript[18] + "<b>"+tablicax[8]+"</b><br>Razem Zagród: <b>"+razemzag+"</b><br>" + langScript[21] + "<b>"+tablicax[10]+"</b><br>" + langScript[12] + "<b>"+tablicax[11]+"</b><br>";
    ...
    switch(game_data.locale) {
        case "en_DK":
        UI.InfoMessage("Use in the Village Information<br>(Middle icon by clicking on the village on the map)<br><br><img src='https://natanprog.github.io/images/mp_info.png'>",8000,"error");
        break;
        case "pt_BR":
        UI.InfoMessage("Use na Informação da aldeia<br>(Ícone do meio clicando na aldeia no mapa)<br><br><img src='https://natanprog.github.io/images/mp_info.png'>",8000,"error");
        break;
        default:
        UI.InfoMessage("Uruchom w informacjach o wiosce<br>(Środkowa ikonka klikając na wioskę na mapie)<br><br><img src='https://natanprog.github.io/images/mp_info.png'>",8000,"error");
    }
};